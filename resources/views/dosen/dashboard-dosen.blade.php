        ...
        <div class="flex justify-center">
            <div class="w-full md:w-4/4">
                <div class="bg-white rounded-lg shadow-md bg">
                    ...
                    <p class="text-xl/8 font-medium mb-3">Anda bukan wali kelas.</p>
                    <p class="text-xl/8 font-medium mb-3" >Kelas anda yang ampu {{ auth()->user()->dosen->kelas->name ?? 'tidak ada' }}</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="bg-white rounded-lg shadow-xl p-4">
                                ...
                                <div class="px-4 py-6">
                                    <p class="text-2xl font-bold">yaaa</p>
                                </div>
                            </div>
                        </div>
                    </div>
